...
public class FileWritersJavaIo {
    ...
    public static void main(String[] args) {
        File file = new File("C:/Users/LENOVO/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/file.txt");

        try (PrintStream ps = new PrintStream("C:/Users/LENOVO/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/fileps.txt")){
//            fileWriter("C:/Users/LENOVO/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/file.txt");
//            bufferedWriter(file);
            ...
            System.out.println("Το αρχείο δεν δημιουργήθηκε ή κάποιο λάθος συνέβη κατα την εγγραφή");
        }
    }
