...
public class BankApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            deposit(amount);
            System.out.println("Tο υπόλοιπο μετά την κατάθεση είναι: " + balance);
        } catch (Exception e) {
    ...
    public static void deposit(double amount) throws Exception {
        try {
            if (amount < 0) throw new Exception("Amount cannot be negative"); // το e.getMessage που ορίσαμε εμείς
            balance += amount;
            // logging
        } catch (Exception e) {
